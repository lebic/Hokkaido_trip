...
export const TRAVELS_REGISTRY: TravelMeta[] = [
  ...
  },
  {
    ...
    description: 'Vienne, Salzbourg, Hallstatt et Munich : palais, concert classique et trains entre Autriche et Bavière.',
    descriptionEn: 'Vienna, Salzburg, Hallstatt and Munich: palaces, a classical concert and trains across Austria and Bavaria.',
